...
<head>
    ...
    <title>Tambah Galeri - Cafe Candaria</title>
    ...
    <main class="main-content">
        ...
        <div class="edit-card">
            <div class="edit-header">
                ...
                <p>Unggah foto baru untuk galeri cafe</p>
            </div>
            ...
            <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="keterangan" name="keterangan" class="form-input-text" placeholder="Contoh: Suasana Cafe">
                </div>
