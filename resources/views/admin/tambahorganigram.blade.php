...
<head>
  ...
  <title>Tambah Pengurus - Cafe Candaria</title>
      ...
      <div class="form-content-wrapper">
        <div class="form-card">
          <div class="form-header">
            <h2 class="form-title">Tambah Pengurus</h2>
            <p class="form-subtitle">Perbaharui pengurus di bawah ini</p>
          </div>
          ...
          <form action="{{ route('admin.organigram.store') }}" method="POST" class="add-data-form" enctype="multipart/form-data">
            @csrf
