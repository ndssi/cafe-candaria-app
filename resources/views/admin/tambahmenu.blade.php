...
<head>
  ...
  <title>Tambah Menu - Cafe Candaria</title>
      ...
      <div class="form-content-wrapper">
        <div class="form-card">
          <div class="form-header">
            ...
            <p class="form-subtitle">Tambahkan menu baru di bawah ini</p>
          </div>
          ...
          <form action="{{ route('admin.menu.store') }}" method="POST" class="add-data-form" enctype="multipart/form-data">
            @csrf
            
            <div class="form-group">
              <label for="nama_menu" class="form-label">Nama Menu</label>
              <input type="text" id="nama_menu" name="nama_menu" class="form-control" placeholder="Contoh: Es Tea Jus" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="harga" name="harga" class="form-control" placeholder="Contoh: 2.000 atau 2000" required>
            </div>
