...
<head>
  ...
  <title>Hapus Pengurus - Cafe Candaria</title>
    ...
    <main class="main-content">
      ...
      <div class="delete-content-wrapper">
        <div class="delete-card">
          ...
          <h2 class="delete-title">Hapus pengurus ini?</h2>
          <p class="delete-description">
            Data yang sudah di hapus tidak bisa dikembalikan. Pastikan kamu yakin sebelum melanjutkan.
          </p>

          <!-- DISPLAY DATA PENGURUS YANG AKAN DIHAPUS -->
          <div class="target-input-box">
            <input type="text" value="{{ $organigram->nama ?? '' }}" readonly class="readonly-target-input">
          </div>

          <!-- ACTION BUTTONS -->
          <form action="{{ route('admin.organigram.destroy', $organigram->id ?? '') }}" method="POST" class="delete-actions-form">
            @csrf
            @method('DELETE')
