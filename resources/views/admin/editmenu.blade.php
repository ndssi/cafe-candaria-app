...
<head>
  ...
  <title>Edit Menu - Cafe Candaria</title>
      ...
      <div class="form-content-wrapper">
        <div class="form-card">
          <div class="form-header">
            ...
            <p class="form-subtitle">Perbaharui data menu di bawah ini</p>
          </div>
          ...
          <form action="{{ route('admin.menu.update', $id ?? '') }}" method="POST" class="add-data-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
              ...
              <select id="kategori" name="kategori" class="form-control" required>
                <option value="Minuman" {{ (isset($menu) && $menu->kategori == 'Minuman') ? 'selected' : '' }}>Minuman</option>
            ...
            <div class="form-group">
              ...
              <input type="text" id="harga" name="harga" class="form-control" placeholder="Contoh: 2.000 atau 2000" value="{{ $menu->harga ?? '' }}" required>
            </div>
            ...
            <div class="form-group">
              ...
              @if (!empty($menu->gambar))
                <div style="margin-bottom:8px;">
                  <img src="{{ asset('storage/' . $menu->gambar) }}" alt="{{ $menu->nama_menu }}" style="width:90px; height:70px; object-fit:cover; border-radius:6px; border:1px solid #ddd;">
                </div>
              @endif
